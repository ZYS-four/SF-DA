...
parser.add_argument('--root_path', type=str, default='/home/eda/ZYSD/PROMISE12', help='Name of Experiment')
parser.add_argument('--exp', type=str, default='SF-DA', help='experiment_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "./model/SF-DA/PROMISE12_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
    test_save_path = "./model/SF-DA/PROMISE12_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
