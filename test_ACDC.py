...
parser.add_argument('--root_path', type=str, default='/home/eda/ZYSD/ACDC', help='Name of Experiment')
...
def Inference(FLAGS):
    ...
    snapshot_path = "./model/SF-DA/ACDC_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
    test_save_path = "./model/SF-DA/ACDC_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
